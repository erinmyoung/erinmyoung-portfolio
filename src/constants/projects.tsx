...
export const THEME_1999_SRC = `${VERCEL_PATH}projects/theme/1999-m6yksy933zsC1ldhbZxtcuyUSTLNVB.webp`;

export const THEME_2000_SRC = `${VERCEL_PATH}projects/theme/2000-Bd9ypSMdEK6AeZgyKZEP5tAutgOhUG.webp`;

export const THEME_2003_SRC = `${VERCEL_PATH}projects/theme/2003-YLgclrwk7S44OFgewBBndraBO5IdCh.webp`;

export const THEME_2005_SRC = `${VERCEL_PATH}projects/theme/2005-I83Tr2cQTq2z2Kzz0UxRDwDYdy7goT.webp`;

export const THEME_2005_BELOW_SRC = `${VERCEL_PATH}projects/theme/2005-below-ff2ApS0FkKy9Z2Omz6Kw8RWSlglIPE.webp`;

export const THEME_2011_SRC = `${VERCEL_PATH}projects/theme/2011-yeKxWpDZnmYjNnsngLTL83FomUhisQ.webp`;
